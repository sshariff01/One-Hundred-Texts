# Django settings for hundred_texts project.

import os

# The top directory for this project. Contains requirements/, manage.py,
# and README.rst, a hundred_texts directory with settings etc (see
...
PROJECT_PATH = os.path.join(PROJECT_ROOT, 'hundred_texts')
...
SECRET_KEY = '^+h#0m7cwc#-#tn+b36hy)!4#*pt7o=3x4v&7jak&)a)z_5kr9'
...
ROOT_URLCONF = 'hundred_texts.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'hundred_texts.wsgi.application'
